...
function md5(string) {
  ...
  const x=convertToWordArray(unescape(encodeURIComponent(string)));let a=0x67452301,b=0xEFCDAB89,c=0x98BADCFE,d=0x10325476;
...
async function wbiGet(path, params) {
  ...
  const url = (path.startsWith('http') ? path : ('https://api.bilibili.com' + path)) + '?' + qs;
